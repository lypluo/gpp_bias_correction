...
# save(par_PFTs,file = paste0(base.path,"data/parameters_MAE_add_baseGDD/","optim_par_run100_beni_PFTs.rds"))
```
...
```{r message=FALSE,warning=FALSE}
load(paste0(base.path,"data/parameters_MAE_add_baseGDD/","optim_par_run100_beni_PFTs.rds"))
