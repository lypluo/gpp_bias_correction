...
#######################################################
#update in March,07:Normlize the gpp and use two parametes scaling( e and f)
#----------
library(tidyverse)
library(GenSA)
#-------------------------
...
save(par_PFTs,file = paste0(base.path,"data/parameters_MSE_add_baseGDD/test/","optim_par_run5000_beni_forDBF_updated.rds"))

#--------------------------------------------------------------
#(5) compare the gpp_obs, ori modelled gpp, and gpp modelled using optimated parameters
#--------------------------------------------------------------
load(paste0(base.path,"data/parameters_MSE_add_baseGDD/test/","optim_par_run5000_beni_forDBF_updated.rds"))
...
unique(df_final_new[df_final_new$classid=="DBF",]$sitename)
